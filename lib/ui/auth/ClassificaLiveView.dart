...
class ClassificaLiveView extends StatelessWidget {
  ...
  final VoidCallback? onBackToVoting; // 👈 Callback per tornare alla votazione nel file principale

  const ClassificaLiveView({
    super.key,
    required this.eventId,
    this.onBackToVoting, required String eventTitle,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        // Assegniamo i primi tre posti del podio in base dei dati reali
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        onPressed: onBackToVoting, // 👈 Aziona la funzione passata dal padre
